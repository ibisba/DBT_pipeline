...
Galaxy tool that takes for input a tar.xz of rpSBML files and parses the IBIBSA annotations and puts them in the a CSV report
...
<section id="retro" name="Retro Nodes">
  <tool file="/local/path/config_rpReport.xml" />
</section>
```
...
```
docker build -t ibisba/rpreport .
```
